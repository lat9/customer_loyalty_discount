...
=== rewritten for PHP 7.3 throuth 8.2, to be used in Zen Cart 1.5.7 and 1.5.8 ===
=== Version 2.0.0 has not been tested with older obsolete Zen Cart versions ===
...
This addon is an beginner installation for Zen Cart 1.5.7 and 1.5.8 and was tested with PHP 7.3 - 8.2.
...
For example, in admin you might have set the pre-defined rolling period to a month
and set up a table of discounts that gives 5.0% discount if they have spent 
over $1000 in the previous month or 7.5% if they have spent over $1500 in the previous month.
...
03/29/2018  1.5     webchills           bugfix for gift certificates in cart, code rewritten for PHP 7 and 7.1
11/24/2019  1.5.1   webchills           Fixes to avoid PHP 7.3 warnings